 ...
 * @author Desktop
 */
public class UpdateReservationPage extends javax.swing.JFrame {

    /** Creates new form UpdateReservationPage */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateReservationPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateReservationPage().setVisible(true);
            }
        });
    }
